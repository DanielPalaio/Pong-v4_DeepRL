...
class DuelingDQN(keras.Model):
    def __init__(self, num_actions, fc1):
        ...
        self.flat = Flatten()
        self.dense = Dense(fc1, activation='relu')
...
class Agent:
    def __init__(self, lr, discount_factor, num_actions, epsilon, batch_size, input_dims):
        ...
        self.q_net = DuelingDQN(num_actions, 512)
        self.q_target_net = DuelingDQN(num_actions, 512)
